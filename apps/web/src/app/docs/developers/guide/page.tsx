    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-foreground-secondary text-lg">
          Scenarios are TPMJS&apos;s AI-powered testing and evaluation system for tool collections.
          They provide automated testing, quality tracking, and regression prevention for your
          tools.
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-foreground-secondary">
            A Scenario is a test case that simulates how a real user would interact with your tool
            collection. Unlike traditional unit tests that verify individual functions, scenarios
            exercise your tools end-to-end with realistic prompts and assertions.
          </p>
          ...
          <div className="bg-background-secondary p-4 rounded-lg space-y-3">
            ...
            <ul className="space-y-2 text-foreground-secondary">
              ...
              <li>
                <strong>Realistic Prompt:</strong> The agent executes your scenario&apos;s prompt
                against the tools
              </li>
              <li>
              ...
              <li>
                <strong>Result Recording:</strong> All results are stored for quality tracking and
                historical analysis
              </li>
            </ul>
          </div>
        ...
        <CardContent className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-background-secondary p-4 rounded-lg">
              ...
              <p className="text-foreground-secondary text-sm">
                Use LLM evaluation to verify your tools actually solve real problems, not just pass
                code tests.
              </p>
            </div>
            <div className="bg-background-secondary p-4 rounded-lg">
          ...
          <div className="mt-6">
            ...
            <ul className="space-y-2 text-foreground-secondary">
              <li>
                <strong>Multi-Tool Integration:</strong> Testing how multiple tools work together in
                complex workflows
              </li>
              <li>
                <strong>API-First Tools:</strong> Validating tools that make HTTP requests or parse
                unstructured data
              </li>
              <li>
                <strong>Quality-Critical Collections:</strong> When tool reliability impacts user
                experience
              </li>
              <li>
                <strong>Regression Prevention:</strong> Before deploying changes that might break
                existing functionality
              </li>
              <li>
                <strong>Documentation-Driven Testing:</strong> Ensuring tools work as described in
  ...
  "assertions": [
    {
      ...
      "description": "Output should contain email addresses"
          ...
          <div>
            ...
            <p className="text-foreground-secondary mb-2">
              When a scenario runs, an ephemeral AI agent is created with your tool collection. The
              agent executes the scenario prompt using only the tools in that collection—no external
              access, no additional context.
            </p>
            <CodeBlock
...
→ Agent collects results for LLM evaluation`}
          ...
          <div>
            ...
            <p className="text-foreground-secondary mb-2">
              After execution, a powerful LLM evaluates the results. This isn&apos;t just checking
              for errors—it uses natural language understanding to verify the task was completed
              correctly.
            </p>
            <CodeBlock
...
Execution Time: 2.3s`}
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-4">
              ...
              <div className="bg-red-500/10 p-4 rounded-lg">
                <h5 className="font-semibold text-red-600 dark:text-red-400 mb-2">⚠️ On Failure</h5>
                <ul className="space-y-1 text-foreground-secondary text-sm">
            ...
            <p className="text-foreground-secondary text-sm mt-4">
              <strong>Example:</strong> A scenario that passes 5 times consecutively earns 25% bonus
              (50% + 5×5) for a total score of ~75%. High-quality scenarios (75%+) are featured on
              the TPMJS homepage showcase.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-foreground-secondary ml-4">
              <li>
                <strong>Full Transparency:</strong> See exactly what the agent asked and how each
                tool responded
              </li>
              <li>
        ...
        <CardContent className="space-y-4">
          <div className="border-l-4 border-border pl-4">
            ...
            <p className="text-foreground-secondary text-sm mb-3">
              Automate scenario testing in your deployment pipeline to catch regressions before they
              reach production.
            </p>
            <CodeBlock
        ...
        run: |
          ...
          echo "✅ All scenarios passed"}`}
            ...
            <p className="text-foreground-secondary text-sm mt-2">
              <strong>Benefits:</strong> Block deploys on failures, generate test reports, and track
          ...
          <div className="border-l-4 border-border pl-4">
            ...
            <p className="text-foreground-secondary text-sm mb-3">
              Test scenarios locally during development to verify tool behavior without consuming
              quota.
            </p>
            <CodeBlock
...
tpm scenario info clu123abc456 --json > analysis.json`}
          ...
          <div className="border-l-4 border-border pl-4">
            ...
            <p className="text-foreground-secondary text-sm mb-3">
              Use scenario results to build dashboards showing tool reliability, success rates, and
              performance trends.
            </p>
            <CodeBlock
...
curl -X POST https://your-monitoring.com/webhook \\
  ...
  -d @metrics.json`}
          ...
          <div className="border-l-4 border-border pl-4">
            ...
            <p className="text-foreground-secondary text-sm mb-3">
              Ensure your tools work correctly with scenarios before publishing them. High-quality
              scenarios increase tool visibility on the TPMJS homepage.
            </p>
            <CodeBlock
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border">
                  ...
                  <th className="text-left py-3 px-4 font-semibold text-foreground">Unit Tests</th>
              ...
              <tbody className="divide-y divide-border">
                ...
                <tr>
                  ...
                  <td className="py-3 px-4 text-foreground-secondary">Better with refactoring</td>
                ...
                <tr>
                  ...
                  <td className="py-3 px-4 text-foreground-secondary">Stack traces, breakpoints</td>
                  <td className="py-3 px-4 text-foreground-secondary">
...
echo "All scenarios ran"`}
          ...
          <div>
            ...
            <p className="text-foreground-secondary text-sm">
              Share high-quality scenarios across organizations, enabling collaborative testing and
              faster scenario coverage for popular tools.
            </p>
          </div>
          ...
          <div className="mt-6 p-4 bg-background-secondary rounded-lg">
            ...
            <p className="text-foreground-secondary text-sm">
              ...
              Before users install a tool, they&apos;ll see its scenario history, quality scores,
